...
public class StorageSevice {
  ...
  @Async
  public CompletableFuture<String> uploadFileOnAzureAsync(MultipartFile file,String uniqueBlobName ) {
      try {
          // Construct Azure Blob Storage URL
          String blobServiceUrl = "https://satyaprofilestorage.blob.core.windows.net";
          String blobContainerUrl = String.format("%s/%s", blobServiceUrl, containerName);
          ...
          return CompletableFuture.completedFuture(fileUrlWithSas);
       } catch (IOException e) {
          e.printStackTrace();
          return null;
      }
